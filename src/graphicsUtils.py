...
# Port to Python 3 done by Anderson Tavares (artavares .at. inf.ufrgs.br)
...
import time
import types
import tkinter  # dooneevent errors fixed via: https://stackoverflow.com/a/7714643/1251716
